...
const imgs = [
  ...
  "https://stgaccinwbsdevlrs01.blob.core.windows.net/newcorporatewbsite/homepage-banners/February2025/3awSWYmdv3ShIr1e9ViZ.webp?w=3840&q=75",
];
...
const Images = () => {
  ...
  return (
    <div>
      ...
      <LandingPage />
      <div
        className={`${merriweather.className}  text-center p-5 text-7xl font-semibold  whitespace-nowrap text-black font-serif`}
      >
        {" "}
        Our Services{" "}
      </div>
